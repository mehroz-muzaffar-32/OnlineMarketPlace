...
namespace OnlineMarketPlaceTorico.Shared
{
    public class ItemsRepository
    {
        ...
        static public int CurrentSellerId = 0;
        static public List<Product> ItemsList { get; set; } = new List<Product>();
        static public List<Category> Categories { get; set; } = new List<Category>();
